      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-8 items-start">
        ...
        <div className="lg:col-span-2 bg-white rounded-[2rem] shadow-xl border border-slate-100 overflow-hidden">
          ...
          <form onSubmit={handleSend} className="p-10 space-y-8">
            ...
            <div>
              ...
              <div className="relative mt-2">
                <select
                  ...
                  className="w-full bg-slate-100 rounded-xl px-5 py-4 font-bold text-sm appearance-none"
                >
                ...
                <ChevronDown className="absolute right-5 top-1/2 -translate-y-1/2" />
              </div>
            </div>
            ...
            <input
              ...
              className="w-full bg-slate-100 rounded-xl px-5 py-4 font-bold text-sm"
            />
            ...
            <textarea
              ...
              className="w-full bg-slate-100 rounded-xl px-5 py-4 font-bold text-sm resize-none"
            />
            ...
            <div>
              ...
              {["Students", "Faculty", "Staff"].map((role) => (
                <button
                  ...
                  type="button"
                  onClick={() => toggleRole(role)}
                  className={`mr-2 mb-2 px-4 py-2 rounded-lg text-xs font-bold ${
                    targetRoles.includes(role)
            ...
            <div>
              ...
              <button
                type="button"
                onClick={() => toggleChannel("Email")}
                className={`mr-2 px-4 py-2 rounded-lg text-xs font-bold ${
                  channels.includes("Email")
                    ? "bg-blue-600 text-white"
                    : "bg-slate-200"
                }`}
              ...
              >
                <Smartphone size={14} className="inline mr-1" /> SMS
              </button>
            </div>
            ...
            <div className="grid grid-cols-2 gap-4">
              <input
                ...
                className="bg-slate-100 rounded-xl px-5 py-4 font-bold text-sm"
              />
              <input
                type="time"
                value={scheduleTime}
            ...
            <div className="flex justify-end">
              <button
                disabled={loading}
                className="bg-blue-600 text-white px-8 py-3 rounded-xl text-xs font-bold uppercase flex items-center gap-2"
              >
        ...
        <div className="space-y-6">
          <StatCard
            ...
            icon={<MailCheck />}
          />
          <StatCard label="Pending" count={pendingCount} icon={<Clock />} />
          <StatCard label="Failed" count={failedCount} icon={<MessageSquareX />} />
        </div>
      </div>
    </div>
  );
...
const StatCard = ({ label, count, icon }) => (
  <div className="bg-white rounded-[2rem] p-6 shadow-xl border flex items-center gap-6">
